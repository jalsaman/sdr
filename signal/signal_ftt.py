...
# Generated: Sat Oct 26 19:11:22 2019
##################################################
...
class signal_ftt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._waveform_tool_bar)
        self._freq_range = Range(0, samp_rate, 1, samp_rate/2, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, 'Frequency', "slider", float)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, waveform, freq, 1, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.samp_rate/2, self.samp_rate)
